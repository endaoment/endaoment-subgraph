...
export function createDefaultDonationFeeSetEvent(
  entityType: i32,
  fee: BigInt
): DefaultDonationFeeSet {
  let defaultDonationFeeSetEvent = changetype<DefaultDonationFeeSet>(
    newMockEvent()
  )
...
export function createDefaultPayoutFeeSetEvent(
  entityType: i32,
  fee: BigInt
): DefaultPayoutFeeSet {
...
export function createDefaultTransferFeeSetEvent(
  ...
  let defaultTransferFeeSetEvent = changetype<DefaultTransferFeeSet>(
    newMockEvent()
  )
  ...
  defaultTransferFeeSetEvent.parameters.push(
    new ethereum.EventParam(
      "fromEntityType",
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(fromEntityType))
    )
  )
  defaultTransferFeeSetEvent.parameters.push(
    new ethereum.EventParam(
      "toEntityType",
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(toEntityType))
    )
  )
  defaultTransferFeeSetEvent.parameters.push(
    new ethereum.EventParam("fee", ethereum.Value.fromUnsignedBigInt(fee))
...
export function createDonationFeeReceiverOverrideSetEvent(
  ...
  let donationFeeReceiverOverrideSetEvent = changetype<
    DonationFeeReceiverOverrideSet
  >(newMockEvent())
...
export function createEntityStatusSetEvent(
  entity: Address,
  isActive: boolean
): EntityStatusSet {
  ...
  entityStatusSetEvent.parameters.push(
    new ethereum.EventParam("entity", ethereum.Value.fromAddress(entity))
  )
  entityStatusSetEvent.parameters.push(
...
export function createFactoryApprovalSetEvent(
  factory: Address,
  isApproved: boolean
): FactoryApprovalSet {
  ...
  factoryApprovalSetEvent.parameters.push(
...
export function createOwnershipTransferProposedEvent(
  user: Address,
  newOwner: Address
): OwnershipTransferProposed {
  let ownershipTransferProposedEvent = changetype<OwnershipTransferProposed>(
    newMockEvent()
  )
...
export function createPayoutFeeOverrideSetEvent(
  entity: Address,
  fee: BigInt
): PayoutFeeOverrideSet {
  let payoutFeeOverrideSetEvent = changetype<PayoutFeeOverrideSet>(
    newMockEvent()
  )

  payoutFeeOverrideSetEvent.parameters = new Array()

  payoutFeeOverrideSetEvent.parameters.push(
    new ethereum.EventParam("entity", ethereum.Value.fromAddress(entity))
  )
  payoutFeeOverrideSetEvent.parameters.push(
    new ethereum.EventParam("fee", ethereum.Value.fromUnsignedBigInt(fee))
...
export function createPortfolioStatusSetEvent(
  portfolio: Address,
  isActive: boolean
): PortfolioStatusSet {
  ...
  portfolioStatusSetEvent.parameters.push(
    new ethereum.EventParam("portfolio", ethereum.Value.fromAddress(portfolio))
  )
  portfolioStatusSetEvent.parameters.push(
    new ethereum.EventParam("isActive", ethereum.Value.fromBoolean(isActive))
  )
...
export function createPublicCapabilityUpdatedEvent(
  ...
  let publicCapabilityUpdatedEvent = changetype<PublicCapabilityUpdated>(
    newMockEvent()
  )
...
export function createRoleCapabilityUpdatedEvent(
  ...
  let roleCapabilityUpdatedEvent = changetype<RoleCapabilityUpdated>(
    newMockEvent()
  )
...
export function createSwapWrapperStatusSetEvent(
  swapWrapper: Address,
  isSupported: boolean
): SwapWrapperStatusSet {
  let swapWrapperStatusSetEvent = changetype<SwapWrapperStatusSet>(
    newMockEvent()
  )
  ...
  swapWrapperStatusSetEvent.parameters.push(
    new ethereum.EventParam(
      "swapWrapper",
      ethereum.Value.fromAddress(swapWrapper)
    )
  )
  swapWrapperStatusSetEvent.parameters.push(
    new ethereum.EventParam(
...
export function createTransferFeeReceiverOverrideSetEvent(
  ...
  let transferFeeReceiverOverrideSetEvent = changetype<
    TransferFeeReceiverOverrideSet
  >(newMockEvent())
...
export function createTransferFeeSenderOverrideSetEvent(
  ...
  let transferFeeSenderOverrideSetEvent = changetype<
    TransferFeeSenderOverrideSet
  >(newMockEvent())
  ...
  transferFeeSenderOverrideSetEvent.parameters.push(
    new ethereum.EventParam(
      "fromEntity",
      ethereum.Value.fromAddress(fromEntity)
    )
  )
  transferFeeSenderOverrideSetEvent.parameters.push(
    new ethereum.EventParam(
...
export function createUserRoleUpdatedEvent(
  user: Address,
  role: i32,
  enabled: boolean
): UserRoleUpdated {
