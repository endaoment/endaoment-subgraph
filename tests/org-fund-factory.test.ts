...
describe('Describe entity assertions', () => {
  beforeAll(() => {
    let entity = Address.fromString('0x0000000000000000000000000000000000000001')
    let entityType = 123
    let entityManager = Address.fromString('0x0000000000000000000000000000000000000001')
    let newEntityDeployedEvent = createEntityDeployedEvent(entity, entityType, entityManager)
  ...
  test('EntityDeployed created and stored', () => {
    ...
    assert.fieldEquals('EntityDeployed', '0x0000000000000000000000000000000000000001', 'entityType', '123')
    assert.fieldEquals(
      'EntityDeployed',
      '0x0000000000000000000000000000000000000001',
      'entityManager',
