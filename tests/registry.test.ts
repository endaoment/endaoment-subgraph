...
describe('Describe entity assertions', () => {
  beforeAll(() => {
    ...
    let newAuthority = Address.fromString('0x0000000000000000000000000000000000000001')
    let newAuthorityUpdatedEvent = createAuthorityUpdatedEvent(user, newAuthority)
